 ...
 * @author User
 */
public class AM_AddOwnweShipController implements Initializable {
    ...
    @FXML
    private TextField noOfSharetxt;
    @FXML
    ...
    private void addBtnOnClick(ActionEvent event) throws IOException {
         ...
         String s1 = nametxt.getText();
            String s2 = noOfSharetxt.getText();
               String s3 = percentagetxt.getText();
        
                
                Assistant_Manager.addOwnerShip(s1,s2,s3,msgLAbel);
    }
