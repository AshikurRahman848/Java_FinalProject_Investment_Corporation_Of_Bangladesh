 ...
 * @author User
 */
public class AM_AddEmployeeInfoController implements Initializable {
    ...
    private void addBtnOnClick(ActionEvent event) throws IOException {
        ...
        String s2 = positiontxt.getText();
                String s3 = degreetxt.getText();
                
                Assistant_Manager.addEmp(s1,s2,s3,msgLAbel);
