 ...
 * @author User
 */
public class Investor_sendStockBuyRequestController implements Initializable {
    ...
    private void addBtnOnClick(ActionEvent event) throws IOException {
        ...
        String a = companyNAmetxt.getText();
                   String b =  sharetxt.getText();
                   
                
                    
                     Investor.sendStockBuyRequest(a, b);
    }
